...
{
	public class AdminController : HIControllerBase
	{
		public AdminController() { }

		public AdminController(IQuotesEntitySource dataSource): base(dataSource) { }
		...
		public ActionResult UserPolicies()
		{
			...
			using (QuotesEntity qe = new QuotesEntity())
			{
				...
				policyList.AddRange(qe.Policies.Where(p => p.Quote.Property.Location.Homeowner.UserId == ho.UserId));
